...
void check_alumno(string code, Tabla & tabla_1, Alumno &alu);
...
{
    Tabla tabla_1(TAM);  //Tabla en la que almacenaremos los alumnos.
    string code = "";
    ...
    check_alumno(code, tabla_1, res);      // Comprobamos alumno que existe.
    check_alumno("asdasdd", tabla_1, res); // Comprobamos alumno que no existe.
